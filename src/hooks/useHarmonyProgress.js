...
const STORAGE_KEY = 'harmony-progress';
...
// Per-lesson progress for the Harmony & Chord Theory course — same
// localStorage persistence pattern (and independent storage key) as
// useCircleOfFifthsProgress.js/useScalesProgress.js.
