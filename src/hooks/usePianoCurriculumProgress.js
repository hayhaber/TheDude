...
const STORAGE_KEY = 'piano-curriculum-progress';
...
// Per-lesson progress for the Piano course — same localStorage persistence
// pattern (and independent storage key) as useHarmonyProgress.js/
// useCircleOfFifthsProgress.js/useChordsByEarProgress.js.
export function usePianoCurriculumProgress() {
  ...
  function entryFor(lessonId) {
    return progress[lessonId] ?? { completed: false, quizCorrect: 0, quizTotal: 0 };
  }
